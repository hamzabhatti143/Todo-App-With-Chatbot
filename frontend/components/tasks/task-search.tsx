    ...
    <div className={cn('relative', className)}>
      ...
      {localValue && (
        <motion.button
          type="button"
          onClick={handleClear}
          className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-300 transition-colors p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center"
